    ...
    <div class="justify-content-end nav collapse navbar-collapse">
      <ul class="nav">
        <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu dropdown-menu-lg-end bg-dark" aria-labelledby="navbarDropdown">
            <li><a class="dropdown-item text-light align-self-center" href="#">Català</a></li>
